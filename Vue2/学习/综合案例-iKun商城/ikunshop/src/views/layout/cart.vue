  ...
  <div class="cart">
    ...
    <div v-if="isLogin && cartList.length > 0">
      ...
      <div class="all-total">
        ...
        <div v-else class="delete" :class="{ disabled: selNum === 0 }" @click="handleDel">删除</div>
      </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('cart', ['selNum', 'selPrice', 'cartTotal', 'selCartList', 'isAllChecked']),
    isLogin () {
